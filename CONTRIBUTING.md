...
Obfuscate loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/UseMuffin/Obfuscate/tree/gh-pages)
...
Obfuscate tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
...
You can build the documentation using Docker via the following commands:
    ...
    # make the html
    docker run -it --rm -v $(pwd)/docs:/data UseMuffin/Obfuscate make html
...
* [Bug tracker](https://github.com/UseMuffin/Obfuscate/issues)
